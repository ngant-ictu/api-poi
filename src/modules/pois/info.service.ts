                        ...
                        if (key >= 1) {
                            if (item[0].length > 0) {
                                ...
                                if (typeof place !== 'undefined') {
                                    ...
                                    if (
                                        typeof responsePlace.json.result.international_phone_number !== "undefined"
                                    ) {
                                    ...
                                    if (
                                        ...
                                        // get city
                                        const myCity = await this.regionsService.findCityByName(
                                            parsedAddr.cityName
                                        );
                                        ...
                                        try {
                                            ...
                                            if (typeof opening_hours !== "undefined") {
                                                if (
                                                    ...
                                                    console.log(
                                                        `#${myPoiInfo.id} ${myPoiInfo.name} work full times!`
                                                    );
                                                } else {
